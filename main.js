...
const NOVEL_DATA = [
    ...
    { author: "暗黒の儀式", title: "あなたにだけは、わかってほしい", tags: ["あ行", "現代", "ヤンデレ・執着", "SF・ファンタジー"] },
    { author: "愛なんだ", title: "この恋は予知不可能！？", tags: ["あ行", "学園・青春", "ラブコメ", "少し不思議"] },
    { author: "朝凪 SANA(^^)", title: "嘘は硝煙に紛れて", tags: ["あ行", "現代恋愛", "アクション", "サスペンス"] },
    ...
    { author: "木谷日向子", title: "冬薔薇の戀", tags: ["か行", "戦争・歴史", "ダークロマンス", "ヤンデレ・執着"] },
    { author: "霞灯里", title: "堕天使ちゃんは逃げ惑う", tags: ["か行", "異世界", "SF・ファンタジー", "コメディ", "百合"] },
    { author: "ぐるんぐるんin福岡", title: "福岡異世界転移史・外伝22 観測される弾道（シュレディンガー・ショット）― 西糸島の絶対零度 ―灰色のルージュ", tags: ["か行", "SF・ファンタジー", "サスペンス", "現代"] },
    ...
    { author: "錠月栞", title: "似合いの二人～契約カップルが本当の恋人になるまで～", tags: ["さ行", "学園・青春", "ラブコメ", "現代恋愛"] },
    ...
    { author: "保桜さやか", title: "【糖度高め】王子様に呪いをかけた罪で自ら国外追放された引きこもり魔女は変わり者の騎士と共に更生することを誓います 〜フローラと彼女の騎士の物語〜", tags: ["は行", "異世界", "SF・ファンタジー", "ほのぼの"] },
    { author: "ひくま しろ", title: "キミくんとお前ちゃん", tags: ["は行", "現代", "コメディ", "ほのぼの"] },
    { author: "冬飼 陸", title: "ルナ騒ぎ", tags: ["は行", "現代", "コメディ", "少し不思議"] },
    ...
    { author: "みなかみもと", title: "クラウドナイン", tags: ["ま行", "異世界", "SF・ファンタジー", "ほのぼの"] },
    ...
    { author: "夜野ケイ(@youarenot）", title: "女魔王が俺にだけ甘えてくる話", tags: ["や行", "異世界", "SF・ファンタジー", "ラブコメ", "ヤンデレ・執着"] },
